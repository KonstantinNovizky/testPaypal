    ...
    <div class="container-login100">
        <div class="wrap-login100">
            ...
            <form class="login100-form validate-form" action="{{ route('users.store') }}" method="post">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <a href="{{ route('main') }}" style="border-radius:25px;" class="btn btn-dark btn-block ">Back</a>
                    </div>
                    <div class="col-md-6 ">
                        <button type="submit" style="border-radius:25px;" class="btn btn-primary btn-block">Subscribe</button>
                    </div>
                </div>
