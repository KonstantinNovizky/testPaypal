...
<head>
    ...
    <link
        rel="stylesheet"
        href="{{ asset('bower_components/jvectormap/jquery-jvectormap.css') }}"
    >
    <!-- Date Picker -->
    <link
        rel="stylesheet"
...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            >
                ...
                <span
                    class="logo-mini"><b>{{ env('APP_NAME_SHORT') }}</b></span>
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        ...
                                        <li>
                                            <a href="#">
                                                <i
                                                    class="fa fa-warning text-yellow"></i>
                        ...
                        <li class="">
                            <a
                                href="{{ route('logout') }}"
                                class="btn btn-flat text-capitalize"
                            >
                        ...
                        {{-- <li class="dropdown user user-menu">
                            ...
                            >
                                ...
                                <span
                                    class="hidden-xs">{{ Session::get("name") }}</span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                >
                    ...
                    @endphp
                    <li
                        class="{{ preg_match('/dashboard/i', $active) ? 'active' : '' }}">
                        <a href="{{ url('admin') }}">
                    ...
                    <li
                        class="{{ preg_match('/trades/i', $active) ? 'active' : '' }}">
                        <a href="{{ route('user_trades.index') }}">
                            <i class="fa fa-trademark"></i>
                            <span class="text-capitalize">trades</span>
                        </a>
                    </li>
                    <li
                        class="{{ preg_match('/users/i', $active) ? 'active' : '' }}">
                        <a href="{{ route('user_users.index') }}">
                            <i class="fa fa-users"></i>
                            <span class="text-capitalize">users</span>
                        </a>
                    </li>
                    <li
                        class="{{ preg_match('/profile/i', $active) ? 'active' : '' }}">
                    ...
                    {{-- <li
                        class="{{ preg_match('/edit user profile/i', $active) ? 'active' : '' }}">
                        <a href="#">
                            <i class="fa fa-pencil"></i>
                    ...
                    <li
                        class="{{ preg_match('/option alerts/i', $active) ? 'active' : '' }}">
                        <a href="#">
                            <i class="fa fa-object-ungroup"></i>
                            <span class="text-capitalize">option alerts</span>
                        </a>
                    </li>
                    <li
                        class="{{ preg_match('/options flow/i', $active) ? 'active' : '' }}">
                        <a href="#">
                            <i class="fa fa-object-ungroup"></i>
                            <span class="text-capitalize">options flow</span>
                        </a>
                    </li>
                    <li
                        class="{{ preg_match('/dart pool data/i', $active) ? 'active' : '' }}">
                        <a href="#">
                            <i class="fa fa-database"></i>
                            <span class="text-capitalize">dart pool data</span>
                        </a>
                    </li>
                    <li
                        class="{{ preg_match('/unusual volume/i', $active) ? 'active' : '' }}">
                        <a href="#">
                            <i class="fa fa-volume-up"></i>
                            <span class="text-capitalize">unusual volume</span>
                        </a>
                    </li>
                    <li
                        class="{{ preg_match('/market news/i', $active) ? 'active' : '' }}">
                        <a href="#">
                            <i class="fa fa-rss"></i>
                            <span class="text-capitalize">market news</span>
                        </a>
                    </li>
                    <li
                        class="{{ preg_match('/pivot points search/i', $active) ? 'active' : '' }}">
                        <a href="#">
                            <i class="fa fa-search"></i>
                            <span class="text-capitalize">
                                pivot points search
                    ...
                    <li
                        class="{{ preg_match('/documents/i', $active) ? 'active' : '' }}">
                        <a href="#">
                    ...
                    <li
                        class="{{ preg_match('/testimonial/i', $active) ? 'active' : '' }}">
                        <a href="#">
                    ...
                    {{-- <li class=" treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="index2.html"><i
                                        class="fa fa-circle-o"></i> Dashboard
                                    v2</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="pages/forms/general.html"><i
                                        class="fa fa-circle-o"
                                    ></i> General Elements</a></li>
                            <li><a href="pages/forms/advanced.html"><i
                                        class="fa fa-circle-o"
                                    ></i> Advanced Elements</a></li>
                    ...
                    <li>
                        <a href="pages/mailbox/mailbox.html">
                            ...
                            <span class="pull-right-container">
                                ...
                                <small
                                    class="label pull-right bg-green">16</small>
                    ...
                    <ul class="control-sidebar-menu">
                        ...
                        <li>
                            <a href="javascript:void(0)">
                                ...
                                <div class="menu-info">
                                    <h4 class="control-sidebar-subheading">Cron
                                        Job 254 Executed</h4>
    ...
    <!-- Sparkline -->
    <script
        src="{{ asset('bower_components/jquery-sparkline/dist/jquery.sparkline.min.js') }}"
    >
    </script>
    <!-- jvectormap -->
    <script
    ...
    <!-- jQuery Knob Chart -->
    <script
        src="{{ asset('bower_components/jquery-knob/dist/jquery.knob.min.js') }}"
    ></script>
    <!-- daterangepicker -->
    <script src="{{ asset('bower_components/moment/min/moment.min.js') }}">
    </script>
    <script
        src="{{ asset('bower_components/bootstrap-daterangepicker/daterangepicker.js') }}"
    >
    </script>
    <!-- datepicker -->
    <script
        src="{{ asset('bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') }}"
    ></script>
    <!-- Bootstrap WYSIHTML5 -->
    <script
    ...
    <!-- Slimscroll -->
    <script
        src="{{ asset('bower_components/jquery-slimscroll/jquery.slimscroll.min.js') }}"
    >
    </script>
    <!-- FastClick -->
